...
def h5id15convert(h5id15, scanid, scan_dim, mot1_name='hry', mot2_name='hrz', ch0id='falconx_det0', ch2id='falconx2_det0', i0id='fpico2', i0corid='pico2', i1id='fpico3', i1corid='pico3', icrid='trigger_count_rate', ocrid='event_count_rate', atol=None, sort=True):
